...
我一直从事软件开发相关工作，将近14年；我了解整个软件开发的全过程，需求分析、系统设计、数据库设计、编码、测试、运维等。我有丰富的项目经历，做过10多个大小项目，大部分是web开发、也有app开发。
...
另外，我喜欢的运动是篮球，基本保持一周两次的节奏。适量的运动有助于身心健康，而健康是一切幸福的基础。
...
I'll take a few minutes to introduce myself to give you a full understanding of my capabilities, my perspective, and my project experience.

I have been working on software development for nearly 14 years. I understand the entire software development process, requirements analysis, system design, database design, coding, testing, operation and maintenance. I have extensive project experience and have worked on more than 10 projects, mostly web development and app development.

In most projects, I am the *key member* or the project leader and delivering the project successfully; why succeed？ I think the most *important*  thing is the design, which can be a system design or a function design. I always guarantee that the design is before the programming. After designed, no matter what programming language you can implement it ； there are also a variety of programming languages in my project, such as java, javascript, IOS object-c, vb.net, which is a good proof of my point of view.

The key ability to do a good design is the logical ability and consider the problem comprehensively; I think I'm good at logically thinking  and coming up with a complete solution. So I can do requirements, design, coding, and even testing.

In addition, my favorite sport is basketball,  basically twice a week. *The exercise is helpful to*  physical and mental health, which is the basis of all happiness.
...
我要介绍的项目是一个医疗企业针对新产品引入中国市场的过程管理，（**New Product Launch Project** ）叫NPL； ，NPL项目以任务管理的方式，将新产品拿证前各团队任务进行系统化记录、追踪，使得新产品上市流程透明化，加强团队间协同，统一管理各类注册用文件，加速新产品上市流程
...
The project I want to introduce is the process management of a medical enterprise for the introduction of new products into the Chinese market,  called NPL ,  short for "New Product Launch"; NPL project uses task management to systematically record and track the tasks of each team before new product is licensed, so as to make the process of new product listing transparent, strengthen team collaboration, unify management of various registration documents, and speed up the process of new product listing

The system uses Spring Cloud  micro-service architecture.

I am the only backend developer ,so my job include business design, system design, Database design ,coding and testing.

Although  This is a small project,  all software development processes must be completed  by myself. This is a challenge for me.
...
1.先：bench最长多长时间？ 一方面我问一下以前的同事有没有机会，再来未来经济会好转工作机会也会都出来，一方面个人还是很认可埃森哲的，呆了快7年了也都签了无固定期限合同；我身边的同事都有 bench5，6个月的；
...
再：协商方案、N+1肯定不能同意，无固定期限合同的保护体现再哪里？

1. N +1，还是2N，这种可行？2*7=14--8 == 11 = N+4 （是最低标准，对于无固定期限合同可以多一点，你的权限下能到多少？）--公司统一标准
2. N 是performance上年total compensation /12 吗？-是 ， 合同里明确写了 十三薪按比例发放吧？-是
3. last day -- 能否到本月底？项目交接需要一周时间---可到3/1
4. *单位辞退的经济补偿金交接时结清 ，本月工资本月底、 十三薪等下月底
