...
在大部分项目里，我都是项目骨干，开发骨干、项目组长；能做到这样，我认为最关键的一点就是设计，可以是系统设计，也可以是一个功能的设计，我总是保证设计先行。做好了设计，后面无论用什么编程语言实现都可以，我所做的项目里也有各种编程语言，有java、javascript、ios object-c、vb.net，这很好的证明了我的观点。
...
1. N +1，还是2N，无固定合同，这种可行？2*7=14--8 == 11 = N+4
2. N 是performance上年total compensation /12 吗？ 合同里明确写了 十三薪按比例发放吧？
3. last day -- 能否到本月底？
4. *单位辞退的经济补偿金一般在解除劳动合同的15日之后拿到* ，本月工资本月底、 十三薪等下月底

*无固定期限劳动合同解除,如是协商一致,就由双方协商经济补偿金*; 
